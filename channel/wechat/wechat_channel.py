    ...
    def send(self, reply: Reply, context: Context):
        ...
        if reply.type == ReplyType.TEXT:
            ...
            if img_format == 'webp':
                ...
                image.save(png_storage, format='PNG')
                png_storage.seek(0)
                itchat.send_image(png_storage, toUserName=receiver)
                logger.info("[WX] sendImage converted from webp to png, url={}, receiver={}".format(img_url, receiver))
            else:
